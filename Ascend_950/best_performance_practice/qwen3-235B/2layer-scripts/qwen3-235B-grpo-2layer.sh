...
project_name='GRPO-Qwen3-235B-MATH'
exp_name='GRPO-Qwen3-235B-Megatron-vLLM'

# Node Info
NNODES=2
NPUS_PER_NODE=${NPUS_PER_NODE:-8}

MODEL_PATH=/Qwen3-235B-A22B-Instruct-2507
MCORE_MODEL_PATH=Qwen/Qwen3-235B-DIST
...
# Training Batch Configuration 64*8/4
train_prompt_bsz=64
...
MODEL_CONFIG=(
    ...
    +actor_rollout_ref.model.override_config.num_hidden_layers=2
)
...
ACTOR_CONFIG=(
    ...
    #+actor_rollout_ref.actor.megatron.override_transformer_config.te_gmm_mode=performance
)
