...
# Qwen3-8B REINFORCE++ with FSDP2 training and vLLM-Ascend rollout on 1 NPU.
#
# Usage:
#   bash run_qwen3_8b_rfpp_fsdp2_npu.sh \
...
project_name=${project_name:-reinforce_plus_plus_qwen3_8b_ascend}
experiment_name=${experiment_name:-qwen3_8b_rfpp_fsdp2_1npu}
