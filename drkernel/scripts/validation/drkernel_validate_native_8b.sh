...
# Override KERNELGYM_DIR to use a checkout elsewhere, or comment this block out to
# validate against an already-running server (set KERNELGYM_SERVER_URL accordingly).
